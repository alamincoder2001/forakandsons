		...
		<div class="col-md-12">
			<div class="table-responsive" id="reportContent">
					...
					<tbody>
						<template v-for="sale in sales">
							...
							<tr style="font-weight:bold;">
								...
								<td style="text-align:center;">Total  Discount {{ sale.saleDetails.reduce((prev,curr)=>{ return prev+parseFloat(curr.Discount_amount)},0) }}</td>
				...
				<table 
					...
					<tbody>
						<tr v-for="sale in sales">
							...
							<td style="text-align:right;">{{ sale.damage_amount }}</td>
					...
					<tfoot>
						<tr style="font-weight:bold;"> 
							...
							<td style="text-align:right;">{{ sales.reduce((prev, curr)=>{return prev + parseFloat(curr.damage_amount)}, 0) }}</td>
				...
				<table 
					...
					<thead>
						<tr>
							<th v-bind:style="{display:  selectedProduct!=null ? '' : 'none'}">Invoice No.</th>
							<th v-bind:style="{display:  selectedProduct!=null ? '' : 'none'}">Date</th>
							<th v-bind:style="{display:  selectedProduct!=null ? '' : 'none'}">Customer Name</th>
							<th>Product Name</th>
							<th>Sales Rate</th>
							<th>Quantity</th>
						</tr>
					...
					<tbody>
						<tr v-for="sale in sales">
							<td v-bind:style="{display:  selectedProduct!=null ? '' : 'none'}">{{ sale.SaleMaster_InvoiceNo }}</td>
							<td v-bind:style="{display:  selectedProduct!=null ? '' : 'none'}">{{ sale.SaleMaster_SaleDate }}</td>
							<td v-bind:style="{display:  selectedProduct!=null ? '' : 'none'}">{{ sale.Customer_Name }}</td>
					...
					<tfoot>
						<tr style="font-weight:bold;">
							<td   v-bind:style="{display:  selectedProduct!=null ? '' : 'none'}" colspan="5" style="text-align:right;">Total Quantity</td>
							<td   v-bind:style="{display:  selectedProduct==null ? '' : 'none'}" colspan="2" style="text-align:right;">Total Quantity</td>
